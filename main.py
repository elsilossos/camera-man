...
def display_json_on_image(json_file, output_file="output.jpg", img_size=(300, 400), font_scale=0.5, font_thickness=1):
    ...
    line_height = int(50 * font_scale)  # Adjust line height based on font scale
...
while settings['running']:
    ...
    settings = load_settings()
    setting_image = display_json_on_image(SETTINGS_PATH)
    cv2.imshow('Settings',setting_image)
